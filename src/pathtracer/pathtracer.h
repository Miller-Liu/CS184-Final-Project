...
namespace CGL {
    ...
    public:
         ...
         */
        virtual Vector3D estimate_direct_lighting_hemisphere(const Ray& r, const SceneObjects::Intersection& isect);
        virtual Vector3D estimate_direct_lighting_importance(const Ray& r, const SceneObjects::Intersection& isect);

        virtual Vector3D est_radiance_global_illumination(const Ray& r);
        virtual Vector3D zero_bounce_radiance(const Ray& r, const SceneObjects::Intersection& isect);
        Vector3D one_bounce_radiance(const Ray& r, const SceneObjects::Intersection& isect);
        virtual Vector3D at_least_one_bounce_radiance(const Ray& r, const SceneObjects::Intersection& isect);
